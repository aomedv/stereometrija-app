...
3. Пользователь фиксирует вид, нажав "Подтвердить позицию"
4. Система сохраняет текущее состояние обзора для последующей загрузки
5. Пользователь может сохранить конфигурацию обзора для использования в других файлах, нажав на "Вид" -> "Сохранить обзор" в верхней панели и указав название конфигурации в появишемся окне
6. Пользователь может загрузить конфигурацию обзора в текущий файл, нажав "Вид" -> "Конфигурации обзора" и выбрав нужную конфигурацию
